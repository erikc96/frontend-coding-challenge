...
export const getCountryByName = (name: string, countries: Country[]) => {
  return (
    countries.find((country: any) => country.properties.ADMIN === name) ||
    [EMPTY_COUNTRY][0]
  ); // TODO any
};

export const centerOnCountry = (
  country: Country,
  mapState: GlobalState["mapState"],
  setMapState: GlobalState["setMapState"]
) => {
...
export const isEarthquakeInCountry = (
